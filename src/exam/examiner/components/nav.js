...
import {PersonFill,PeopleFill,PencilSquare,Journal} from "react-bootstrap-icons"


export default function NavBar({show}){
    return(
        <>
            <Navbar sticky="top" bg="primary" expand="lg" variant="dark" className="mb-5">
        ...
        <Container>
          ...
          <img src="../../../fpn.jpg" width="50" height="40" alt="portal logo" className="pe-2 d-inline-block align-top rounded"/>
            ...
            <span className="fw-bold text-uppercase d-none d-lg-inline-block">Examiner Portal</span>
            </LinkContainer>
            </Navbar.Brand>
